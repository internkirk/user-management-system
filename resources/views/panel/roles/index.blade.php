...
<a href="{{ route('roles.create') }}">
    <div class="text-white mt-5 mx-10 font-vazir bg-blue-600 inline-block px-14 py-3 rounded-lg hover:bg-blue-700">
        @lang("translate.create role")
    </div>
</a>
